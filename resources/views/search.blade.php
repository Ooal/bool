...
@section('content')
  ...
  <div class="d-flex" id="wrapper">
      ...
      <div class="bg-light border-right" id="sidebar-wrapper" style="position:relative">
        ...
        <button  class="btn filter-button btn-dark" id="menu-toggle"><i class="fas fa-angle-up"></i>  Filters  <i class="fas fa-angle-up"></i></button>
      </div>
      <!-- /#sidebar-wrapper -->
      ...
      <div class="container">
        @if ($city == '')
        <h1 style="margin-top: 40px ;text-align:center;">Tutti i nostri appartamenti</h1>
        @else
        <h1 style="margin-top: 40px ;text-align:center;">Appartamenti a {{$city}}</h1>
        @endif
